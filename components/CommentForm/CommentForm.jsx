...
//         const { value: name } = nameEl.current;
//         const { value: email } = emailEl.current;
//         const { checked: storeData } = storedData.current;
...
//             <div className={ styles.container }>
//                 <div>
//                     <input className={styles.checkbox} ref={ storedData } type='checkbox' id='storeData' name='storeData' value='true'/>
//                     <label htmlFor="storeData">Remember the data.</label>
//                 </div>
//             </div>
//             { error && <p>All fields are required!</p>}
